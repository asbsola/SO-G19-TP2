...
\begin{enumerate}
    \item Tener un contenedor de docker con la imagen provista por la cátedra.
...
\begin{itemize}
    ...
    \item test\_wait\: Este test crea dos grupos de procesos, los mismos tienen un pequeño delay y luego retornan un valor. Finalmente, el test verifica si la suma de los valores de retorno de ambos grupos fue el mismo, así se testean las syscalls \texttt{wait} y \texttt{wait\_pid}.
\end{itemize}
...
\begin{itemize}
    ...
    \item Error V656. Este error indica que dos variables fueron inicializadas con llamada a una misma función con iguales parámetros. A continuación se muestra un fragmento de código donde se puede ver que es un falso positivo.
\end{itemize}
