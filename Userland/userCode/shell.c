...
ModuleDescriptor modules[] = {
	{"help", "displays available modules", BUILT_IN, help}, {"clear", "clears the screens text buffer", BUILT_IN, cls}, {"sysinfo", "displays system information", PROCESS, info}, {"fontsize", "change font size", BUILT_IN, font_size}, {"time", "display current time", PROCESS, time}, {"regs", "displays captured registers (ESC key to capture)", PROCESS, regs}, {"beep", "beeps", BUILT_IN, beep}, {"song", "plays a short tune while displaying graphics", PROCESS, cucaracha}, {"calculator", "positive integer calculator", PROCESS, calculator}, {"eliminator", "eliminator game", PROCESS, eliminator}, {"jump", "jumps to address given by user in decimal (12345 causes invalid opcode)", PROCESS, jump}, {"test_mm", "tests the memory manager", PROCESS, test_mm}, {"test_processes", "tests processes", PROCESS, test_processes}, {"test_wait", "tests waits and return values", PROCESS, test_wait}, {"test_priority", "tests priority", PROCESS, test_prio}, {"test_priority_dist", "tests priority distribution", PROCESS, test_prio_dist}, {"test_idle_cleanup", "tests idle cleanup of orphans", PROCESS, test_idle_cleanup}, {"test_sync", "tests syncro", PROCESS, test_sync}, {"test_pipes", "tests pipes", PROCESS, test_pipes}, {"mem", "displays memory status", PROCESS, mem}, {"ps", "displays information about processes", PROCESS, ps}, {"nicent", "changes process priority by PID", BUILT_IN, nicent}, {"kill", "terminates a process by its PID. If the flag 'r' is provided, it also terminates all its descendants", BUILT_IN, kill}, {"cleanup", "removes all exited processes", BUILT_IN, cleanup}, {"block", "blocks a procces by a PID", BUILT_IN, block}, {"unblock", "unblocks a procces by a PID", BUILT_IN, unblock}, {"loop", "prints its PID every n seconds", PROCESS, loop}, {"phylo", "the dining philosophers problem", PROCESS, phylo}, {"cat", "print on the standard output", PROCESS, cat}, {"wc", "counts the number of lines of input", PROCESS, wc}, {"filter", "Filters the input vowels", PROCESS, filter}, {"echo", "display a line of text", PROCESS, echo},
};
